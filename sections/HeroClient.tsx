  ...
  return (
    ...
    >
      <div
        ...
        style={artboardCanvasStyle(width, height)}
      >
        {children}
      </div>
    </div>
...
export default function HeroClient() {
  ...
  return (
    ...
    >
      <div className="sticky top-0 flex h-svh min-h-[640px] w-full flex-col overflow-hidden bg-bg-cream">
        <HeroArtboardCanvas mode={mode}>
