...
export default function FeaturedWorkClient() {
  ...
  return (
    <section
      ...
      className="min-h-svh w-full snap-start bg-white"
    >
      <div className="mx-auto w-full max-w-[1440px] px-6 py-24 md:px-[88px] md:py-[100px]">
        <div className="mb-[82px] flex flex-col gap-4">
          <motion.div
            className="flex items-center gap-2.5 rounded py-2"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-40px" }}
            transition={HEADER_TRANSITION}
          >
            <div className="relative h-[54px] w-[42px] shrink-0 overflow-hidden">
              <Image
                src={workAssets.caseStudiesIcon}
                alt=""
                width={42}
                height={54}
                className="absolute h-[106%] w-[136%] max-w-none -left-[18%] -top-[3%] object-cover"
              />
            </div>
