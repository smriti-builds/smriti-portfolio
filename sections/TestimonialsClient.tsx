...
export default function TestimonialsClient() {
  ...
  return (
    <section aria-label="Recommendations" className="surface-bleed-x w-full min-w-0 overflow-x-clip bg-white">
      <div className="mx-auto w-full min-w-0 max-w-[1440px] px-6 pt-8 pb-40 md:px-[88px] md:pt-10 md:pb-[160px]">
        <header
          className="text-center"
          style={{ marginBottom: `${headingToCardsPx}px` }}
        >
          <motion.h2
            className="type-testimonials-heading font-instrument-sans font-semibold uppercase text-text-primary"
