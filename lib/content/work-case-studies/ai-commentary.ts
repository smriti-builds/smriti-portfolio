...
The vision was to build India's most trusted sports prediction and analytics platform by transforming the second-screen experience from passive score tracking into an interactive, insight-driven companion.`,
  ...
  heroImage: {
    src: "/Work/mockups/ai-commentary.png",
    width: 1850,
    height: 1200,
    alt: "Real time AI commentary interface showing live match predictions and commentary cards",
  },
  meta: {
    duration: "8 weeks",
    status: "Shipped",
      ...
      media: [
        {
          ...
          height: 1200,
          fit: "contain",
          alt: "Final high-fidelity mockup of the real time AI commentary experience on mobile",
          caption: "Final design — live match centre with AI commentary cards",
        },
      ],
    },
    {
